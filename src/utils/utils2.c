...
/*   Updated: 2023/08/07 19:33:39 by cwenz            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	mob->sprites = ft_calloc(mob->num_sprites,
			sizeof(mlx_texture_t *) * mob->num_sprites + 1);
	if (!mob->sprites)
		return (FAIL);
	mob->animated_sprite = ft_calloc(mob->num_sprites,
			sizeof(mlx_image_t *) * mob->num_sprites + 1);
